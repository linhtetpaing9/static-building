...
export const GeneralForm = Form.create<{ form: WrappedFormUtils, wrappedComponentRef, rowGutter }>()(
      ...
      return (
        <Form>
          <Row type="flex" gutter={rowGutter}>
            <Col xs={24} md={12} style={{ paddingBottom: rowGutter }}>
          ...
          <Row type="flex" gutter={rowGutter}>
            <Col xs={24} style={{ paddingBottom: rowGutter }}>
              <label>Message *</label>
              <Form.Item>
...
export class ContactFormComponent extends React.Component<any, any>{
      ...
      if (!error) {
        ...
        */
        ...
        const result = await this.client.emailAdmins({
          ...
          admin_emails: [this.props.adminEmails || config.email]
        }, values)
  ...
  render () {
    ...
    let contactForm = <GeneralForm wrappedComponentRef={(formRef) => { this.formRef = formRef }} rowGutter={this.props.rowGutter || 0} />
